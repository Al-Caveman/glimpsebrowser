...
from glimpsebrowser.api import (cmdutils, hook, config, message, downloads,
...
def adblock_update() -> None:
    ...
    This updates `~/.local/share/glimpsebrowser/blocked-hosts` with downloaded
    host lists and re-reads `~/.config/glimpsebrowser/blocked-hosts`.
    """
