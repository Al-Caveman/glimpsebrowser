...
from glimpsebrowser.mainwindow import tabwidget, mainwindow
from glimpsebrowser.browser import signalfilter, browsertab
from glimpsebrowser.utils import (log, usertypes, utils, qtutils, objreg,
...
class TabbedBrowser(QWidget):
    ...
    Attributes:
        ...
        default_window_icon: The glimpsebrowser window icon
    ...
    def _remove_tab(self, tab, *, add_undo=True, new_undo=True, crashed=False):
        ...
        if tab.url().isEmpty():
            ...
            # this.
            # [1] https://github.com/glimpsebrowser/glimpsebrowser/issues/163
            pass
