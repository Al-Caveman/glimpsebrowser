...
from glimpsebrowser.config import config, configtypes, configexc
from glimpsebrowser.utils import usertypes, log, utils, qtutils, objreg, message
...
class PromptQueue(QObject):
    ...
    def _pop(self):
        ...
        if self._queue:
            ...
            if not question.is_aborted:
                ...
                # download. See
                # https://github.com/glimpsebrowser/glimpsebrowser/issues/415 and
                # https://github.com/glimpsebrowser/glimpsebrowser/issues/1249
    ...
    def ask_question(self, question, blocking):
        ...
        if self._shutting_down:
            ...
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/95
