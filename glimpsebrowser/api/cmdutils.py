...
"""glimpsebrowser has the concept of functions, exposed to the user as commands.
...
from glimpsebrowser.commands import command, cmdexc
# pylint: disable=unused-import
from glimpsebrowser.utils.usertypes import KeyMode, CommandValue as Value
...
class CommandError(cmdexc.Error):
    ...
    The message will then be shown in the glimpsebrowser status bar.

    .. note::

       You should only raise this exception while a command handler is run.
       Raising it at another point causes glimpsebrowser to crash due to an
       unhandled exception.
    """
...
class argument:  # noqa: N801,N806 pylint: disable=invalid-name
    ...
    - ``value``: Tell glimpsebrowser to fill the argument with special values:
