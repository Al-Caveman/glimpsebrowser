...
"""Types for options in glimpsebrowser's configuration.
...
1) As an object which can be represented in YAML:
   ...
   This is what glimpsebrowser actually saves internally, and also what it gets
...
from glimpsebrowser.misc import objects, debugcachestats
from glimpsebrowser.config import configexc, configutils
from glimpsebrowser.utils import (standarddir, utils, qtutils, urlutils, urlmatch,
                               usertypes)
...
class Command(BaseType):
    ...
    """A glimpsebrowser command with arguments.
