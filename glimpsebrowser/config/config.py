...
from glimpsebrowser.config import configdata, configexc, configutils
from glimpsebrowser.utils import utils, log, jinja, urlmatch
...
if MYPY:
    ...
    from glimpsebrowser.config import configcache, configfiles
