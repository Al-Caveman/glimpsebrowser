...
from glimpsebrowser.config import configexc, config, configdata, configutils
from glimpsebrowser.keyinput import keyutils
from glimpsebrowser.utils import standarddir, utils, qtutils, log, urlmatch

MYPY = False
if MYPY:
    # pylint: disable=unused-import, useless-suppression
    from glimpsebrowser.misc import savemanager
...
class ConfigAPI:
    ...
    Attributes:
        ...
        configdir: The glimpsebrowser config directory, as pathlib.Path.
        datadir: The glimpsebrowser data directory, as pathlib.Path.
    """
...
class ConfigPyWriter:
    ...
    def _gen_header(self) -> typing.Iterator[str]:
        ...
        yield self._line("#   glimpse://help/configuring.html")
        yield self._line("#   glimpse://help/settings.html")
        yield ''
        if self._commented:
