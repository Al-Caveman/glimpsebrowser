...
from glimpsebrowser.completion.models import configmodel
from glimpsebrowser.utils import objreg, message, standarddir, urlmatch
from glimpsebrowser.config import configtypes, configexc, configfiles, configdata
from glimpsebrowser.misc import editor
from glimpsebrowser.keyinput import keyutils

MYPY = False
if MYPY:
    # pylint: disable=unused-import,useless-suppression
    from glimpsebrowser.config.config import Config, KeyConfig


class ConfigCommands:

    """glimpsebrowser commands related to the configuration."""
    ...
    def set(self, win_id: int, option: str = None, value: str = None,
        ...
        Args:
            ...
            temp: Set value temporarily until glimpsebrowser is closed.
            print_: Print the value after setting.
        """
        if option is None:
            tabbed_browser = objreg.get('tabbed-browser', scope='window',
                                        window=win_id)
            tabbed_browser.load_url(QUrl('glimpse://settings'), newtab=False)
            return
    ...
    def config_list_add(self, option: str, value: str,
        ...
        Args:
            ...
            temp: Add value temporarily until glimpsebrowser is closed.
        """
        with self._handle_config_error():
            opt = self._config.get_opt(option)
    ...
    def config_list_remove(self, option: str, value: str,
        ...
        Args:
            ...
            temp: Remove value temporarily until glimpsebrowser is closed.
        """
        with self._handle_config_error():
            opt = self._config.get_opt(option)
        valid_list_types = (configtypes.List, configtypes.ListOrValue)
