...
from glimpsebrowser.utils import log, qtutils, message, utils
from glimpsebrowser.browser.network import pac


# FIXME: we probably could raise some exceptions on invalid URLs
# https://github.com/glimpsebrowser/glimpsebrowser/issues/108
...
def is_special_url(url):
    ...
    if not url.isValid():
        return False
    special_schemes = ('about', 'glimpse', 'file')
...
def qurl_from_user_input(urlstr):
    ...
    FIXME - Maybe https://codereview.qt-project.org/#/c/93851/ has a better way
            to solve this?
    https://github.com/glimpsebrowser/glimpsebrowser/issues/109
...
def safe_display_string(qurl):
    ...
    See https://github.com/glimpsebrowser/glimpsebrowser/issues/2547
