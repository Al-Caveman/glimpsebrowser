...
def _init_py_warnings():
    ...
    # This happens in many glimpsebrowser dependencies...
...
def qt_message_handler(msg_type, context, msg):
    ...
    suppressed_msgs = [
        ...
        # https://github.com/glimpsebrowser/glimpsebrowser/issues/1287
        "QXcbClipboard: SelectionRequest too old",
        # https://github.com/glimpsebrowser/glimpsebrowser/issues/2071
...
class RAMHandler(logging.Handler):
    ...
    def dump_log(self, html=False, level='vdebug'):
        ...
        https://github.com/glimpsebrowser/glimpsebrowser/issues/34
        """
