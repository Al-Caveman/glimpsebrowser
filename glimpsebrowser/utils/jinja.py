...
from glimpsebrowser.utils import utils, urlutils, log, qtutils, javascript
from glimpsebrowser.misc import debugcachestats
...
<html>
  ...
  <body>
    ...
    Please check your glimpsebrowser installation
      </span><br>
      %ERROR%
    </p>
  </body>
...
class Environment(jinja2.Environment):
    ...
    def _resource_url(self, path):
        """Load images from a relative path (to glimpsebrowser).
