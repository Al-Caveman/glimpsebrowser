...
from glimpsebrowser.utils import qtutils, log
...
def read_file(filename, binary=False):
    """Get the contents of a file contained with glimpsebrowser.
    ...
    if hasattr(sys, 'frozen'):
        ...
        data = pkg_resources.resource_string(glimpsebrowser.__name__, filename)
        if not binary:
...
def resource_filename(filename):
    """Get the absolute filename of a file contained with glimpsebrowser.
    ...
    return pkg_resources.resource_filename(glimpsebrowser.__name__, filename)
...
def sanitize_filename(name, replacement='_'):
    ...
    # See https://github.com/glimpsebrowser/glimpsebrowser/issues/427
...
def open_file(filename, cmdline=None):
    ...
    from glimpsebrowser.misc import guiprocess
...
def yaml_load(f):
    ...
    if delta > deadline:  # pragma: no cover
        log.misc.warning(
            ...
            "https://github.com/glimpsebrowser/glimpsebrowser/issues/2777\n"
            "duration: {}s\n"
            "PyYAML version: {}\n"
            "C extension: {}\n"
            "Stack:\n\n"
