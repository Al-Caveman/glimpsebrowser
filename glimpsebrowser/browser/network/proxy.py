...
from glimpsebrowser.config import config, configtypes
from glimpsebrowser.utils import objreg, message, usertypes, urlutils
...
class ProxyFactory(QNetworkProxyFactory):
    ...
    """Factory for proxies to be used by glimpsebrowser."""
