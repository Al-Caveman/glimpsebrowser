...
from glimpsebrowser.utils import message, usertypes, log, urlutils, utils, debug
from glimpsebrowser.browser import downloads
from glimpsebrowser.browser.webkit import http
...
class DownloadManager(downloads.AbstractDownloadManager):
    ...
    def get_mhtml(self, tab, target):
        ...
        from glimpsebrowser.browser.webkit import mhtml
    ...
    def get_request(self, request, *, target=None,
        ...
        if suggested_fn is None:
            suggested_fn = 'glimpsebrowser-download'
