...
from glimpsebrowser.utils import (utils, objreg, usertypes, log, qtutils,
                               urlutils, message)
from glimpsebrowser.misc import miscwidgets, objects
from glimpsebrowser.browser import eventfilter, hints
from glimpsebrowser.qt import sip
MYPY = False
if MYPY:
    # pylint can't interpret type comments with Python 3.7
    # pylint: disable=unused-import,useless-suppression
    from glimpsebrowser.browser import webelem
    from glimpsebrowser.browser.inspector import AbstractWebInspector
...
class AbstractTab(QWidget):
    ...
    def send_event(self, evt: QEvent) -> None:
        ...
        if recipient is None:
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/3888
    ...
    def _on_load_finished(self, ok: bool) -> None:
        ...
        try:
            ...
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/4311
            return
