...
from glimpsebrowser.config import configdata, config
from glimpsebrowser.browser import browsertab, eventfilter, shared, webelem
from glimpsebrowser.browser.webengine import (webview, webengineelem, tabhistory,
                                           interceptor, webengineglimpsescheme,
                                           cookies, webenginedownloads,
                                           webenginesettings, certificateerror)
from glimpsebrowser.misc import miscwidgets
from glimpsebrowser.utils import (usertypes, qtutils, log, javascript, utils,
...
def init():
    ...
    log.init.debug("Initializing glimpse://* handler...")
    _glimpse_scheme_handler = webengineglimpsescheme.GlimpseSchemeHandler(parent=app)
    _glimpse_scheme_handler.install(webenginesettings.default_profile)
    if webenginesettings.private_profile:
        _glimpse_scheme_handler.install(webenginesettings.private_profile)
    ...
    def _find(self, text, flags, callback, caller):
        ...
        def wrapped_callback(found):
            ...
            if self._pending_searches > 0:
                # See https://github.com/glimpsebrowser/glimpsebrowser/issues/2442
...
class WebEngineCaret(browsertab.AbstractCaret):
    ...
    def selection(self, callback):
        ...
        # https://github.com/glimpsebrowser/glimpsebrowser/issues/3523
    ...
    def _update_pos(self, pos):
        ...
        if scrollable_x == 0:
            ...
            try:
                ...
                # https://github.com/glimpsebrowser/glimpsebrowser/issues/3219
...
class _WebEngineScripts(QObject):
    ...
    def _inject_early_js(self, name, js_code, *,
        ...
        for injection in ['creation', 'ready']:
            ...
            script.setName('_glimpse_{}_{}'.format(name, injection))
    ...
    def _remove_early_js(self, name):
        ...
        scripts = self._widget.page().scripts()
        for injection in ['creation', 'ready']:
            full_name = '_glimpse_{}_{}'.format(name, injection)
            script = scripts.findScript(full_name)
            if not script.isNull():
                scripts.remove(script)

    def init(self):
        """Initialize global glimpsebrowser JavaScript."""
            ...
            try:
                ...
                if not 0 <= world <= qtutils.MAX_WORLD_ID:
                    log.greasemonkey.error(
                        "script {} has invalid value for '@glimpse-js-world'"
...
class WebEngineTab(browsertab.AbstractTab):
    ...
    def _restore_zoom(self):
        if sip.isdeleted(self._widget):
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/3498
            return
    ...
    def load_url(self, url, *, emit_before_load_started=True):
        ...
        """
        if sip.isdeleted(self._widget):
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/3896
            return
    ...
    def _on_history_trigger(self):
        try:
            ...
            # https://crashes.glimpsebrowser.org/view/3abffbed (Qt 5.9.1)
    ...
    def _on_navigation_request(self, navigation):
        ...
        if navigation.url == QUrl('glimpse://print'):
