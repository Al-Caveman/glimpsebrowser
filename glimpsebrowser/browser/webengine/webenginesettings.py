...
from glimpsebrowser.browser.webengine import spell, webengineglimpsescheme
from glimpsebrowser.config import config, websettings
from glimpsebrowser.config.websettings import AttributeInfo as Attr
from glimpsebrowser.utils import utils, standarddir, qtutils, message, log
            ...
            if not local_filename:
                if warn:
                    message.warning("Language {} is not installed - see "
                                    "scripts/dictcli.py in glimpsebrowser's "
                                    "sources".format(code))
                continue
