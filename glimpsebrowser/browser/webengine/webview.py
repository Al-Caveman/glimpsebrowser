...
from glimpsebrowser.browser.webengine import webenginesettings, certificateerror
from glimpsebrowser.config import config
from glimpsebrowser.utils import log, debug, usertypes, objreg, qtutils
...
class WebEngineView(QWebEngineView):
    ...
    """Custom QWebEngineView subclass with glimpsebrowser-specific features."""
...
class WebEnginePage(QWebEnginePage):
    ...
    """Custom QWebEnginePage subclass with glimpsebrowser-specific features.
    ...
    def javaScriptConfirm(self, url, js_msg):
        """Override javaScriptConfirm to use glimpsebrowser prompts."""
    ...
    def javaScriptConsoleMessage(self, level, msg, line, source):
        """Log javascript messages to glimpsebrowser's log."""
        level_map = {
