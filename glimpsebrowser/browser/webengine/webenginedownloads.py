...
from glimpsebrowser.browser import downloads, pdfjs
from glimpsebrowser.utils import debug, usertypes, message, log, qtutils
...
class DownloadItem(downloads.AbstractDownloadItem):
    ...
    def __init__(self, qt_item, parent=None):
        ...
        # is deleted. See https://github.com/glimpsebrowser/glimpsebrowser/issues/3373
