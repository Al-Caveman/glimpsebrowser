...
from glimpsebrowser.utils import log, usertypes, utils, objreg, debug
from glimpsebrowser.browser.webkit import webpage


class WebView(QWebView):

    """Custom QWebView subclass with glimpsebrowser-specific features.
