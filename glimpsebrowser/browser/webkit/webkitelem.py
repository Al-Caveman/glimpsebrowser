...
from glimpsebrowser.utils import log, utils, javascript, usertypes
...
class WebKitElement(webelem.AbstractWebElement):
    ...
    def _rect_on_view_js(self) -> typing.Optional[QRect]:
        ...
        if rects is None:  # pragma: no cover
            ...
            # https://github.com/glimpsebrowser/glimpsebrowser/issues/1641
            return None
    ...
    def rect_on_view(self, *, elem_geometry: QRect = None,
        ...
        https://github.com/glimpsebrowser/glimpsebrowser/issues/1298
