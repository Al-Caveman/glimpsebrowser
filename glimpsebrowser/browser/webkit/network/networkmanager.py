...
if MYPY:
    ...
    from glimpsebrowser.mainwindow import prompt
from glimpsebrowser.utils import (message, log, usertypes, utils, objreg,
                               urlutils, debug)
from glimpsebrowser.browser import shared
from glimpsebrowser.extensions import interceptors
from glimpsebrowser.browser.webkit import certificateerror
from glimpsebrowser.browser.webkit.network import (webkitglimpsescheme, networkreply,
                                                filescheme)
...
class NetworkManager(QNetworkAccessManager):
    ...
    def __init__(self, *, win_id, tab_id, private, parent=None):
        ...
        self._scheme_handlers = {
            'glimpse': webkitglimpsescheme.handler,
    ...
    # https://github.com/glimpsebrowser/glimpsebrowser/issues/2213
