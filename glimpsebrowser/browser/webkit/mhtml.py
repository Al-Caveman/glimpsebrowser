...
from glimpsebrowser.browser import downloads
from glimpsebrowser.browser.webkit import webkitelem
from glimpsebrowser.utils import log, objreg, message, usertypes, utils, urlutils
...
class MHTMLWriter:
    ...
    def write_to(self, fp):
        ...
        msg = email.mime.multipart.MIMEMultipart(
            'related', '---=_glimpse-{}'.format(uuid.uuid4()))
...
class _Downloader:
    ...
    def _fetch_url(self, url):
        ...
        # glimpse, see the comments/discussion on
        # https://github.com/glimpsebrowser/glimpsebrowser/pull/962#discussion_r40256987
        # and https://github.com/glimpsebrowser/glimpsebrowser/issues/1053
