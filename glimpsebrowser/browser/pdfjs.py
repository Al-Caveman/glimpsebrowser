...
"""pdf.js integration for glimpsebrowser."""

import os

from PyQt5.QtCore import QUrl, QUrlQuery

from glimpsebrowser.utils import (utils, javascript, jinja, qtutils, usertypes,
                               standarddir, log)
...
def should_use_pdfjs(mimetype, url):
    ...
    # e.g. 'blob:glimpse%3A///b45250b3-787e-44d1-a8d8-c2c90f81f981'
    is_download_url = (url.scheme() == 'blob' and
                       QUrl(url.path()).scheme() == 'glimpse')
...
def get_main_url(filename):
    ...
    url = QUrl('glimpse://pdfjs/web/viewer.html')
    query = QUrlQuery()
