...
from glimpsebrowser.config import configfiles
from glimpsebrowser.utils import log, usertypes
...
def create(parent=None):
    ...
    if objects.backend == usertypes.Backend.QtWebEngine:
        from glimpsebrowser.browser.webengine import webengineinspector
        return webengineinspector.WebEngineInspector(parent)
    else:
        from glimpsebrowser.browser.webkit import webkitinspector
