...
from glimpsebrowser.utils import qtutils, utils, objreg
...
def update_geometry(obj):
    ...
    Original bug:   https://github.com/glimpsebrowser/glimpsebrowser/issues/167
    Workaround bug: https://github.com/glimpsebrowser/glimpsebrowser/issues/171
    """
