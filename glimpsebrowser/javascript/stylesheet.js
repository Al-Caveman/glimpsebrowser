...
window._glimpsebrowser.stylesheet = (function() {
    if (window._glimpsebrowser.stylesheet) {
        return window._glimpsebrowser.stylesheet;
    }
    ...
    funcs.set_css = function(css) {
        ...
        for (let i = 0; i < window.frames.length; ++i) {
            ...
            if (frame._glimpsebrowser && frame._glimpsebrowser.stylesheet) {
                frame._glimpsebrowser.stylesheet.set_css(css);
            }
        }
    };
