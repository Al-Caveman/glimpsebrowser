...
"""Loader for glimpsebrowser extensions."""
...
from glimpsebrowser import components
from glimpsebrowser.config import config
from glimpsebrowser.utils import log, standarddir, objreg
...
class ModuleInfo:
    ...
    This gets used by glimpsebrowser.api.hook.
    """
...
class ExtensionInfo:
    ...
    """Information about a glimpsebrowser extension."""
...
def add_module_info(module: types.ModuleType) -> ModuleInfo:
    ...
    if not hasattr(module, '__glimpse_module_info'):
        module.__glimpse_module_info = ModuleInfo()  # type: ignore
    return module.__glimpse_module_info  # type: ignore


def load_components(*, skip_hooks: bool = False) -> None:
    """Load everything from glimpsebrowser.components."""
...
def _walk_pyinstaller() -> typing.Iterator[ExtensionInfo]:
    ...
    for importer in pkgutil.iter_importers('glimpsebrowser'):
