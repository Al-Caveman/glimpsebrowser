...
from glimpsebrowser.commands import cmdexc
from glimpsebrowser.utils import message, objreg, qtutils, usertypes, utils
from glimpsebrowser.misc import split, objects
...
class CommandParser:
    ...
    """Parse glimpsebrowser commandline commands.
...
class CommandRunner(QObject):
    ...
    """Parse and run glimpsebrowser commandline commands.
