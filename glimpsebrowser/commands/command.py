...
from glimpsebrowser.commands import cmdexc, argparser
from glimpsebrowser.utils import log, message, docutils, objreg, usertypes, utils
from glimpsebrowser.utils import debug as debug_utils
...
class Command:
    ...
    Attributes:
        ...
        _glimpse_args: The saved data from @cmdutils.argument
    ...
    def __init__(self, *, handler, name, instance=None, maxsplit=None,
        ...
        self._glimpse_args = getattr(self.handler, 'glimpse_args', {})
        self.handler.glimpse_args = None
    ...
    def get_arg_info(self, param):
        ...
        return self._glimpse_args.get(param.name, ArgInfo())
    ...
    def get_pos_arg_info(self, pos):
        ...
        return self._glimpse_args.get(name, ArgInfo())
    ...
    def takes_count(self):
        ...
        return any(info.value in self.COUNT_COMMAND_VALUES
                   for info in self._glimpse_args.values())
