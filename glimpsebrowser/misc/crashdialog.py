...
"""The dialog which gets shown when glimpsebrowser crashes."""
...
from glimpsebrowser.utils import version, log, utils, objreg
from glimpsebrowser.misc import (miscwidgets, autoupdate, msgbox, httpclient,
                              pastebin)
...
class _CrashDialog(QDialog):
    ...
    def _get_paste_title(self):
        ...
        title = "glimpse {} {}".format(glimpsebrowser.__version__,
    ...
    def on_version_success(self, newest):
        ...
        cur_version = pkg_resources.parse_version(glimpsebrowser.__version__)
        lines = ['The report has been sent successfully. Thanks!']
        if new_version > cur_version:
            lines.append("<b>Note:</b> The newest available version is v{}, "
                         "but you're currently running v{} - please "
                         "update!".format(newest, glimpsebrowser.__version__))
    ...
    def on_version_error(self, msg):
        ...
        lines.append("There was an error while getting the newest version: "
                     ...
                     "<a href=https://www.glimpsebrowser.org/>glimpsebrowser.org</a> "
...
class ExceptionCrashDialog(_CrashDialog):
    ...
    def _init_text(self):
        super()._init_text()
        text = "<b>Argh! glimpsebrowser crashed unexpectedly.</b>"
...
class FatalCrashDialog(_CrashDialog):
    ...
    def _init_text(self):
        super()._init_text()
        text = ("<b>glimpsebrowser was restarted after a fatal crash.</b><br/>"
                ...
                "glimpsebrowser/blob/master/doc/stacktrace.asciidoc'>"
    ...
    def on_report_clicked(self):
        ...
        if (not self._info.toPlainText().strip() and
            ...
            msgbox.msgbox(parent=self, title='Empty crash info',
                          ...
                          "spend on developing glimpsebrowser instead.\n\nPlease "
                          "help making glimpsebrowser better by providing more "
...
class ReportErrorDialog(QDialog):
    ...
    def __init__(self, exc_text, text, parent=None):
        ...
        label = QLabel("<b>There was an error while reporting the crash</b>:"
                       ...
                       "<a href='mailto:crash@glimpsebrowser.org'>"
                       "crash@glimpsebrowser.org</a> - Thanks!".format(
