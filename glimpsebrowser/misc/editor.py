...
from glimpsebrowser.utils import message, log
...
class ExternalEditor(QObject):
    ...
    def edit(self, text, caret_position=None):
        ...
        try:
            self._filename = self._create_tempfile(text, 'glimpsebrowser-editor-')
        except OSError as e:
    ...
    def _create_tempfile(self, text, prefix):
        ...
        # https://github.com/glimpsebrowser/glimpsebrowser/issues/1767
