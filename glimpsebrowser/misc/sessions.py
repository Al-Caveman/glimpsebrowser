...
from glimpsebrowser.utils import (standarddir, objreg, qtutils, log, message,
                               utils)
    ...
    def _load_tab(self, new_tab, data):
        ...
        for i, histentry in gen:
            ...
            if 'zoom' in data:
                ...
                # earlier.
                # See https://github.com/glimpsebrowser/glimpsebrowser/issues/728
            ...
            if (config.val.session.lazy_restore and
                    ...
                    not histentry['url'].startswith('glimpse://back')):
