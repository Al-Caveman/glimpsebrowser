...
from glimpsebrowser.utils import log, debug
...
class KnownError(Error):
    ...
    disk or I/O errors), where glimpsebrowser isn't to blame.
    """
...
class BugError(Error):
    ...
    This is raised for errors resulting from a glimpsebrowser bug.
    """
