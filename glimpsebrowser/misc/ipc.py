...
from glimpsebrowser.utils import log, usertypes, error, standarddir, utils
...
def _get_socketname_windows(basedir):
    ...
    parts = ['glimpsebrowser', getpass.getuser()]
    ...
    def listen(self):
        ...
        if not utils.is_windows:  # pragma: no cover
            ...
            try:
                ...
                # https://github.com/glimpsebrowser/glimpsebrowser/issues/1530
