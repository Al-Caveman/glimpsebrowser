...
; Installer defines
!define PRODUCT_NAME "glimpsebrowser" ; name of the application as displayed to the user
!define PROGEXE "glimpsebrowser.exe" ; main application filename
!define COMPANY_NAME "glimpsebrowser.org" ; company, used for registry tree hierarchy
!define COPYRIGHT "© 2014-2018 Florian Bruhin (The Compiler)"
!define TM "glimpsebrowser is free software under the GNU General Public License"
!define URL_ABOUT "https://glimpsebrowser.org/"
!define URL_UPDATE "https://glimpsebrowser.org/doc/install.html"
!define HELP_LINK "https://glimpsebrowser.org/doc/help/"
!define CONTACT "mail@glimpsebrowser.org"
