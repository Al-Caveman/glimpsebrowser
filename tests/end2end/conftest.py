...
from end2end.fixtures.glimpseprocess import (glimpseproc_process, glimpseproc,
                                          glimpseproc_new)
from end2end.fixtures.testprocess import pytest_runtest_makereport
from glimpsebrowser.utils import qtutils, utils
from glimpsebrowser.browser.webengine import spell


def pytest_configure(config):
    """Remove old profile files."""
    if config.getoption('--glimpse-profile-subprocs'):
        try:
            shutil.rmtree('prof')
