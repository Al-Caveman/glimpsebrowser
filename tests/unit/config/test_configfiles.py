...
"""Tests for glimpsebrowser.config.configfiles."""
...
from glimpsebrowser.config import (config, configfiles, configexc, configdata,
                                configtypes)
from glimpsebrowser.utils import utils, usertypes, urlmatch
...
def test_state_config(fake_save_manager, data_tmpdir, monkeypatch,
    ...
    monkeypatch.setattr(configfiles.glimpsebrowser, '__version__', '1.2.3')
...
class TestConfigPy:
    ...
    def test_bind_freshly_defined_alias(self, confpy):
        ...
        https://github.com/glimpsebrowser/glimpsebrowser/issues/3001
        """
    ...
    def test_appending(self, config_tmpdir, confpy, option, value):
        ...
        See https://github.com/glimpsebrowser/glimpsebrowser/issues/3104
        """
